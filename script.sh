...
pacstrap /mnt gnome-shell gnome-terminal gnome-tweaks eog gnome-control-center gdm base base-devel efibootmgr firefox git grub intel-ucode amd-ucode linux linux-firmware linux-headers mpv neovim net-tools networkmanager ntfs-3g obs-studio openssh papirus-icon-theme nautilus pipewire pipewire-alsa pipewire-jack pipewire-media-session pipewire-pulse xf86-intel-video &&
